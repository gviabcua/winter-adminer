<?php
    ...
    return [
        ...
        'plugin' => [
            'name'        => 'Adminer pour WinterCMS',
            'description' => 'Charge une instance privée de Adminer depuis le backend d\'WinterCMS'
        ],
        ...
        'settings' => [
            ...
            'iframe'            => 'Iframe',
            'autologin'         => 'Autologin',
            'autologin_comment' => 'Se logue directement dans votre base de données WinterCMS',
            'themes'            => 'Thème',
        ...
        'permissions' => [
            'tab'   => 'Adminer',
            'label' => 'Accés à Adminer depuis le backend d\'WinterCMS'
        ]
