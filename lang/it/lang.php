<?php
    ...
    return [
        ...
        'plugin' => [
            'name'        => 'Adminer per WinterCMS',
            'description' => 'Consente di utilizzare un\'istanza privata di Adminer dal backend di WinterCMS'
        ],
        ...
        'settings' => [
            ...
            'autologin_comment' => 'Esegue automaticamente l\'accesso al database di WinterCMS',
            'themes'            => 'Tema',
            ...
            'use_conn_comment'  => 'Per il login automatico Adminer utilizzerà la connessione predefinita al database di WinterCMS. Da qui è possibile modificare questa impostazione.<br> Aggiungere nuove connessioni dal file <strong>config/database.php</strong>. <a href="https://laravel.com/docs/5.6/database#configuration" target="_blank">Maggiori informazioni</a>',
        ],

        'permissions' => [
            'tab'   => 'Adminer',
            'label' => 'Utilizzo di Adminer dal backend di WinterCMS'
        ]
